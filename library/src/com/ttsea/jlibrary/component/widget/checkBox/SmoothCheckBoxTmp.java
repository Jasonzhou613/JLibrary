...
public class SmoothCheckBoxTmp extends View implements Checkable {
    ...
    public SmoothCheckBoxTmp(Context context) {
        this(context, null);
    }

    public SmoothCheckBoxTmp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmoothCheckBoxTmp(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SmoothCheckBoxTmp(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        ta.recycle();
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(SmoothCheckBoxTmp.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SmoothCheckBoxTmp checkBox, boolean isChecked);
    }
